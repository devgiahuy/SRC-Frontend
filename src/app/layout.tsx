...
export default async function RootLayout({
    ...
    return (
        <html lang={locale} className={`${geistSans.variable} ${geistMono.variable} min-w-xs`}>
            <body className="overflow-x-hidden antialiased bg-secondary diamond-background min-w-xs max-w-screen nextstepjs--active">
                <AppProviders locale={locale}>
                    <ClientHydration>
                        <div className="flex flex-col items-center min-h-screen mb-6 pt-25 ">
                            {children}
                        </div>
                    </ClientHydration>
                </AppProviders>
